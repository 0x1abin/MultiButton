...
static MultiButton buttonList[] = {
    {
        .button_id = 1,
        .hal_button_level = read_button_gpio,
        .active_level = 1,
        .button_level = 0,
        .callback = {
            .single_click = btn1_single_click_handler,
            .double_click = btn1_double_click_handler,
            .long_press_start = btn1_long_press_start_handler,
            .long_press_hold = btn1_long_press_hold_handler,
            .press_repeat = btn1_press_repeat_handler,
        }
    }
}
